...
We show in general that it is sufficient to prove invertibility for non-zero ideals of $A$.
This is done in the lemma \lean{coe\_ideal\_mul\_one\_div}.
We consider, for a non-zero ideal $I$, the ideal $J := I * (1/I)$, and show that $1/J \leq 1 \le J$, hence $J = 1$ since $J \le 1$ holds in an arbitrary domain.
