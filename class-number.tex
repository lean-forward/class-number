...
The lemma statement is parametrized over arbitrary types $K$ and $L$ with a field structure,%TODO : There is something strange going on here....
...
\end{lstlisting}
Some examples of rings of integers include $\Z$ and $\Z[i]$. %We prove ahead that the ring of integers of a number field is, in fact, a Dedekind domain. Moreover, it is a finitely-generated free $\Z$-module, with rank equal to the degree of the number field over $\Q$.%TODO : USEFUL?
