...
This gives the following result: %% Is it possible to just give the name of the lemma?
\begin{lstlisting}
...
%% with \lean{is\_scalar\_tower K L F}, as described in Section \ref{sec:scalar_tower}. Can we remove the listing?
...
This is a consequence of the following two results, formalizing \cite{Neukirch}, corollary 2.7: %% maybe just write the names of the lemmas?
\begin{lstlisting}
