...
%or equivalently 
$R$-submodules $J$ of $F$ such that there is an $x : R$ with $x J \subseteq R$, encoded in the definition~\lean{is\_fractional}. %The reason for introducing them is that, unlike their subset of proper ideals, 
%Recall that, f
