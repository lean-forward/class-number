...
We are not aware of any existing formal developments of Dedekind domains or finiteness results for class groups of global fields.
Since the core library components of our proofs are in ideal theory, field theory, (?commutative algebra?,) and algebraic number theory
%TODO Good list areas. In particular, first few items may be too broad, so that it's easy to miss too much in other provers; to narrowly defined items on the other hand, may not connect to much/anything else..
we provide here a (partial) survey of formalizations in these areas.
%This incomplete list is meant to indicate the depth and flavor of such projects.

The Mathematical Components library in Coq~\cite{mathcomp} has some results about fields extensions, a construction of the algebraic closure of rational numbers, and some Galois theory.
It was mostly geared toward the requirements of the proof of the Odd Order Theorem.
See:
\url{https://github.com/math-comp/math-comp/tree/master/mathcomp/field}
%TODO links will have to be removed, or moved to a footnote or bibliography
In particular, for the (constructive) existence of number fields, see
\url{https://github.com/math-comp/math-comp/blob/master/mathcomp/field/algnum.v}

Perhaps also mention?:
\url{https://github.com/math-comp/math-comp/blob/master/mathcomp/field/algebraics_fundamentals.v}
and
\url{https://hal.inria.fr/file/index/docid/671809/filename/main.pdf}

In Isabelle/HOL \ldots
