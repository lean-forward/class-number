...
\item Verification of number theoretic software, such as KASH/KANT~\cite{kash} and PARI/GP~\cite{PARI2}, e.~g. class number computations for quadratic number fields.

\item Applications to Diophantine equations, as determining all pairs of integers $(x,y)$ such that $y^2=x^3+D$ for % several given ``interesting'' $D\in\Z$.
