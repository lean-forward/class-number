...
Instead, we show that, for every element of an ideal, there exists a \lean{s : finset D} whose span is contained in the ideal, and which contains the element.
