...
\titlegraphic{\includegraphics[scale=.1]{lf_vu.png}\\\includegraphics[scale=.2]{Logo_UJM.png}}
...
\begin{frame}{Representing $\Q(\alpha)$}
	...
	Several constructions of $\Q(\alpha)$: subtype of $\C$, quotient type $\Q[x] / f_\alpha$, ...\\
