...
\titlegraphic{\includegraphics[height=5ex]{lean-forward.png}\includegraphics[height=5ex]{vu.png}\\\includegraphics[width=10em]{LSGNT_banner_logo.jpg}\\\includegraphics[width=10em]{Logo_UJM.png}}
